...
def load_rows_into_bigquery(rows_to_insert, table_id):
  ...
  if errors == []:
    print("New rows have been added in Big Query table.") #@todo remove all print statements
    ...
    logging.error("Encountered errors while inserting rows in BigQuery: {}".format(errors))
