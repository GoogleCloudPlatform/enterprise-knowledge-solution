...
locals {
  ...
  image_name_and_tag       = "${var.region}-docker.pkg.dev/${var.project_id}/${var.artifact_repo}/${var.doc_deletion_cloud_run_job_name}:latest"
}

# See github.com/terraform-google-modules/terraform-google-gcloud
module "gcloud_build_job_to_doc_deletion" {
