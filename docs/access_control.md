...
| ------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | --------------------------------------------------------------------------------------------------------- |
| **Deployer** | Create all the Infrastructure-as-Code (IaC) resources defined in this repository.                                                                                                                 | The deployment guide includes automation to create a service account (`deployer@$PROJECT_ID.iam.gserviceaccount.com`) with the minimum set of IAM roles to deploy all the IaC resources. If you’re following the deployment guide, no further work is required to configure the deployer roles.                                                                                                                                                                                                                                      | [persona_roles_deployer.txt](sample-deployments/composer-orchestrated-process/persona_roles_deployer.txt) |
...
| **Operator** | responsible for day-to-day management of the pipelines, including running airflow jobs, inspecting rejected documents, validating that labels are applied correctly, and general troubleshooting. | The operator has highly privileged access to interact with all the underlying technical services of EKS, including view access to the ingested documents. Depending on your existing ways of working, you might allow the Operator to modify resources directly, or you might grant them view-only access to resources and require any changes to go through your version controlled IaC pipeline.                                                                                                                                   | [persona_roles_operator.txt](sample-deployments/composer-orchestrated-process/persona_roles_operator.txt) |
